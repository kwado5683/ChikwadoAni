...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Subtle grid overlay */}
      <div className="absolute inset-0 bg-grid-slate-200/40 -z-10" />
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="text-5xl md:text-7xl font-extrabold text-slate-800 leading-tight drop-shadow-sm"
          >
            Chikwado{" "}
          ...
          >
            {[
              { href: "https://github.com/kwado5683", icon: <Github className="w-5 h-5" /> },
              { href: "https://www.linkedin.com/in/chikwado-ani-2b6042114/", icon: <Linkedin className="w-5 h-5" /> },
              { href: "mailto:chikwadovalentine2@gmail.com", icon: <Mail className="w-5 h-5" /> }
            ].map(({ href, icon }, i) => (
              <a 
                key={i}
                href={href}
                ...
                text-slate-600 hover:text-blue-600 hover:shadow-xl transition-all duration-300"
              >
                {icon}
              </a>
            ))}
          ...
          {/* Floating scroll-down indicator */}
            ...
            >
                <ChevronDown className="w-8 h-8 text-slate-600 hover:text-blue-600 transition-colors" />
            </motion.div>
        </div>
      </div>
    </section>
